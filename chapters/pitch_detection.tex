...
HPS is a promising algorithm because it is simple and easy to compute making it suitable for real-time analysis. As the HPS essentially looks at the ratio of the harmonics, it can find a missing fundamental. Even if the fundemental is part of the spectrum, it may not always be the strongest in which case the HPS helps by enhancing it for easier discernment from noise.
